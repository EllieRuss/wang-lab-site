        ...
        <div className="px-6 pb-8 lg:px-10 lg:pb-10">
          <div className="max-w-4xl text-white">
            ...
            <button
              ...
              className="mt-6 rounded-full border border-white/80 px-5 py-2 text-sm font-medium text-white transition hover:bg-white hover:text-slate-900"
            >
              Enter Site
            </button>
          </div>
      ...
      <div className="relative overflow-hidden rounded-2xl">
        ...
        <div className="absolute inset-x-0 top-0 p-8 lg:p-10">
          <button
            ...
            className="max-w-4xl text-left text-3xl font-bold leading-tight text-white md:text-5xl"
          >
        ...
        <div className="absolute inset-x-0 bottom-0 p-8 lg:p-10">
          <p className="max-w-4xl text-base leading-7 text-white md:text-xl md:leading-8">
